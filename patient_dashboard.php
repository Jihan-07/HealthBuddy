...
<body>
  <header class="topbar">
    ...
    <nav class="nav">
      <a href="patient_dashboard.php"><i class="fa fa-home"></i> Dashboard</a>
      <a href="Logout.php"><i class="fa fa-sign-out"></i> Logout</a>
      <a href="userProfile.php"><i class="fa fa-user-circle"></i> <?php echo htmlspecialchars($_SESSION['username']); ?></a>
    </nav>
  </header>
